    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="border-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">{mockSubmissions.length}</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Filter submissions by status and assignment</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        {filteredSubmissions.length === 0 ? (
          <Card>
            <CardContent className="py-12 text-center">
              <p className="text-muted-foreground">No submissions found. Try adjusting your filters.</p>
            </CardContent>
          </Card>
        ) : (
            ...
            <Card key={submission.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="pt-0">
                <Link href={`/teacher/grading/${submission.id}`}>
                  <Button className="w-full" variant={submission.status === 'pending' ? 'default' : 'outline'}>
